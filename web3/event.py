...
for data in event:
    ...
    print(token_id)
    print(owner)
#     sql = "INSERT INTO EVENT (token_id, owner) VALUES (%s, %s)"
#     val = (token_id,owner)
